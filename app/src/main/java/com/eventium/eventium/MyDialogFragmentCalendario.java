...
public class MyDialogFragmentCalendario extends DialogFragment {

    private RecyclerView rv;
    private RVAdapter adapter;
    private List<UserModel> mUserModel;
    ArrayList<Calendario> calendarios;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        calendarios = NavigationDrawerActivity.calendarios;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < calendarios.size(); ++i) {
            Integer userid = calendarios.get(i).getUserid();
